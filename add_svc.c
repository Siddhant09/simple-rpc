...
add_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case get_merged_list:
		_xdr_argument = (xdrproc_t) xdr_list;
		_xdr_result = (xdrproc_t) xdr_list;
		local = (char *(*)(char *, struct svc_req *)) get_merged_list_1_svc;
		break;

	case get_reverse_string:
		_xdr_argument = (xdrproc_t) xdr_list;
		_xdr_result = (xdrproc_t) xdr_list;
		local = (char *(*)(char *, struct svc_req *)) get_reverse_string_1_svc;
		break;

	case get_matrix_sum:
		_xdr_argument = (xdrproc_t) xdr_matrix;
		_xdr_result = (xdrproc_t) xdr_matrix;
		local = (char *(*)(char *, struct svc_req *)) get_matrix_sum_1_svc;
		break;
...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, ADD_PROG, ADDS_VERS, add_prog_1, IPPROTO_UDP)) {
	...
	if (!svc_register(transp, ADD_PROG, ADDS_VERS, add_prog_1, IPPROTO_TCP)) {
